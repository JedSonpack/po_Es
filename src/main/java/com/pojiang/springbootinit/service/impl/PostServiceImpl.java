package com.pojiang.springbootinit.service.impl;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.pojiang.springbootinit.common.ErrorCode;
import com.pojiang.springbootinit.constant.CommonConstant;
import com.pojiang.springbootinit.exception.BusinessException;
import com.pojiang.springbootinit.exception.ThrowUtils;
import com.pojiang.springbootinit.mapper.PostFavourMapper;
import com.pojiang.springbootinit.mapper.PostMapper;
import com.pojiang.springbootinit.mapper.PostThumbMapper;
import com.pojiang.springbootinit.model.dto.post.PostQueryRequest;
import com.pojiang.springbootinit.model.entity.Post;
import com.pojiang.springbootinit.model.entity.PostFavour;
import com.pojiang.springbootinit.model.entity.PostThumb;
...
import com.pojiang.springbootinit.utils.SqlUtils;
...
public class PostServiceImpl extends ServiceImpl<PostMapper, Post> implements PostService {
    ...
    public Page<Post> searchFromEs(PostQueryRequest postQueryRequest) {
        ...
        highlightBuilder.preTags("<mark style=\"color:red\">").postTags("</mark>");
//        highlightBuilder.fragmentSize(200); // 高亮片段大小
//        highlightBuilder.numOfFragments(1); // 返回的高亮片段数量
        ...
        NativeSearchQuery searchQuery = new NativeSearchQueryBuilder()
                ...
                .withHighlightBuilder(highlightBuilder) // 加入高亮
